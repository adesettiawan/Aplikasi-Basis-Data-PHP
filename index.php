...
<body>
	...
	<h4> <strong>DATA PROGRAM STUDI</strong></h4>
		<a href="index.php?a=input" class="btn btn-primary mt-3 mb-3"> <i class="fas fa-plus"></i> Tambah Data</a>
		...
		<?php while ($row=mysqli_fetch_array($result)) {?>
			<tr>
				...
				<td>
					<a class="btn btn-primary" href="index.php?a=edit&id=<?php echo $row['idprodi'];?>"> Edit</i></a>
					<a class="btn btn-danger" href="index.php?a=delete&id=<?php echo $row['idprodi'];?>"> Hapus</i></a>
				</td>
			</tr>
	...
	<?php
		...
		<div class="container"><br><br>
			...
			<input type="hidden" name="sql" value="create">
				...
				<div align="right">
					<a class="btn btn-primary" href="index.php?a=list"> Batal</a>
